...
def main():
    ...
    print("=" * 70)
    print("🔬 TEST SMOOTH STARTUP (50 RPM Closed Loop)")
    print("=" * 70)
    ...
    if records:
        ...
        print("\n" + "=" * 70)
        print("STARTUP TRANSIENT (FIRST 500ms):")
        print(f"Max Iq Target in first 500ms: {max(iq_tgt):.3f} A")
        print(f"Max Iq Measured in first 500ms: {max(iq_meas):.3f} A")
        print(f"Initial Iq Target at t=0: {iq_tgt[0]:.3f} A")
        print(f"Initial Iq Measured at t=0: {iq_meas[0]:.3f} A")
